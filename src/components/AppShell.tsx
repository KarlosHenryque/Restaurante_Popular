      ...
      <aside className="sticky top-0 flex h-screen w-[112px] shrink-0 flex-col items-center gap-2 bg-sidebar py-5 text-sidebar-foreground shadow-soft">
        ...
        {nav.map((item) => (
          <Link
            key={item.to}
            to={item.to}
            className="flex w-[88px] flex-col items-center gap-1 rounded-2xl px-2 py-3 text-[11px] font-bold tracking-wide opacity-75 transition-all hover:bg-sidebar-accent hover:opacity-100"
        ...
        <button
          ...
          className="mt-auto flex w-[88px] flex-col items-center gap-1 rounded-2xl px-2 py-3 text-[10px] font-semibold opacity-80 hover:bg-sidebar-accent"
